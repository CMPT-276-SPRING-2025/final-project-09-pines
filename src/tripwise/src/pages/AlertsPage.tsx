  ...
  return (
    <div className="alert-container">
      ...
      <div className="alert-search-row">
        ...
        <motion.button className="filter-button" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              ...
              <div className="alert-details">
                ...
                <div className="alert-price-row">
                  ...
                  <span className={`alert-value ${alert.availability > 80 ? "high-availability" : ""}`}>
                    {alert.availability}% {alert.type === "flight" ? "full" : "booked"}
                  </span>
                </div>
              </div>

              <div className="alert-actions">
                <button className="alert-action-button edit-button" onClick={() => handleEditAlert(alert.id)}>
                  Edit
                </button>
      ...
      <AnimatePresence>
        {showCreateModal && (
          <CreateAlertModal onClose={() => setShowCreateModal(false)} onCreateAlert={handleCreateAlert} />
        )}
      </AnimatePresence>
    </div>
  )
