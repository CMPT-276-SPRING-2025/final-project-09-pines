...
import { Alert, FlightAlert, HotelAlert, convertToAPIFormat, convertToUIFormat } from './models/Alert';
import API_CONFIG from '../config/api';

const API_BASE_URL = API_CONFIG.BASE_URL;

// Create a single alertService object with all methods
const alertService = {
  /**
   * Get all alerts
   */
  ...
  /**
   * Check if origin and destination codes are valid
   */
  ...
  /**
   * Get current flight price - useful for creating new alerts
   */
  ...
  /**
   * Get current hotel price for a location using Amadeus API
   ...
   * @returns {Promise<{price: number, currency: string}>} - Average price data
   */
